...
<p>La somme des deux premières valeurs est : <%= Integer.parseInt(tableauDeChiffres[0]) + Integer.parseInt(tableauDeChiffres[1]) %
...
<% int valeurMaximale = Integer.MAX_VALUE;
    for (String chiffre : tableauDeChiffres) {
        int valeur = Integer.parseInt(chiffre);
